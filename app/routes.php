...
$routes = [
    ...
    'POST' => [
        ...
        '/api/admin/users/role' => 'AdminController@updateUserRoleApi',
        '/api/admin/users/delete' => 'AdminController@deleteUserApi',
        '/api/admin/reports/clean' => 'AdminController@cleanReportsApi',        ],
    'PUT' => [
