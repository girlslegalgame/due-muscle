...
<!-- グラフ描画用に Chart.js を単独で読み込み（app.php側で読んでいない場合のための対策） -->
...
<div id="cardSelectModal" class="card-select-modal">
    <div class="card-select-modal-content">
        <div class="card-select-modal-header">
            ...
            <!-- 選択中カードのバッジ表示エリア -->
            <div id="modalSelectedBadges" class="selected-badges-container" style="display: none;"></div>
        ...
        <!-- カード一覧表示領域 -->
        <div class="card-select-modal-body" id="modalCardList"></div>
...
function toggleUserReportCategories(show) {
    document.getElementById('user_category_wrapper').style.display = show ? 'block' : 'none';
}
